...
export const Footer = () => {
  return (
    <footer className="pt-100 relative z-20 " aria-labelledby="footer-heading">
      <div className="max-w-6xl mx-auto  py-12 px-4 sm:px-6 lg:py-16 lg:pl-8">
        <div className="ml-28 xl:grid xl:grid-cols-2 xl:gap-8">
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-3">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div>
                <h3 className="text-20 font-semibold text-yellow-default uppercase">
                  Technology
                </h3>
