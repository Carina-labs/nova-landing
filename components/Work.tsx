  ...
  return (
    <>
      <div className="relative pt-8 pb-32 overflow-hidden">
        <h1 className="text-tw-white text-34 font-extrabold text-center tracking-tight mb-4">
          How it works
        </h1>

        <div className="border-2 border-yellow-default rounded-md mt-12 mx-24 bg-tw-white">
          {/* 01 Liquid Staking */}
          <div className="lg:mx-auto lg:max-w-5xl lg:px-12 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
            ...
            <div
              id="left"
              className="px-4 max-w-xl mx-auto sm:px-6 lg:py-20 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-1"
            >
              <Image
          ...
          {/* 02 Staked Swap */}
          <div className="w-4/5 m-auto border-y-2 border-yellow-default">
            <div className="lg:mx-auto lg:max-w-5xl lg:px-12 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
                ...
                <div id="left">
                  ...
                  <div className="mt-2">
                    ...
                    <ul className="list-disc font-normal lg:text-lg md:text-base mb-3 md:ml-5 ml-4 md:mt-0 mt-3">
                      ...
                      <li className="mt-3 text-18 text-black">
                        Supernova’s staked swap suggests decent price for
              ...
              <div
                id="right"
                className="px-4 max-w-xl mx-auto sm:px-6 lg:py-20 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2"
              >
                <Image
